...
5. PUBLICACIONES MAS VISTAS
6. USUARIOS POR NIVEL
...
var splinaArea1 = document.querySelector("#nuevosUsuarios");
if (splinaArea1 !== null) {
  var datos = $.getJSON("views/js/scripts_estadisticas/usuarios_registrados.php", function () {
    console.log("success");
  })
    .done(function (datos) {
...
//   /*======== 2. PUBLICACIONES CREADAS ========*/
var splinaArea2 = document.querySelector("#publicacionesCreadas");
if (splinaArea2 !== null) {
  var datos = $.getJSON("views/js/scripts_estadisticas/publicaciones_creadas.php", function () {
    console.log("success");
  })
    .done(function (datos) {
...
//   /*======== 3. INSCRIPCIONES ========*/
var splinaArea3 = document.querySelector("#usuariosInscritos");
if (splinaArea3 !== null) {

  var datos = $.getJSON("views/js/scripts_estadisticas/usuarios_inscritos.php", function () {
    console.log("success");
  })
    .done(function (datos) {
      ...
      var randerSplinaArea2 = new ApexCharts(splinaArea3, splinaAreaOptions3);
      randerSplinaArea2.render();
...
// /*======== 4. SERVICIOS DISPONIBLES ========*/
var splinaArea4 = document.querySelector("#serviciosDisponibles");
if (splinaArea4 !== null) {
  var datos = $.getJSON("views/js/scripts_estadisticas/servicios_disponibles.php", function () {
    console.log("success");
  })
    .done(function (datos) {
      ...
      var randerSplinaArea2 = new ApexCharts(splinaArea4, splinaAreaOptions4);
      randerSplinaArea2.render();
...
//   /*======== 5. PUBLICACIONES MAS VISTAS ========*/
var mixedChart1 = document.querySelector("#publicacionesMasVistas");
if (mixedChart1 !== null) {

  var datos = $.getJSON("views/js/scripts_estadisticas/publicaciones_mas_vistas.php", function () {
    console.log("success");
  })
    .done(function (datos) {
...
/*======== 6. USUARIOS POR NIVEL ========*/
var radialBarChart1 = document.querySelector("#usuariosNivel");
if (radialBarChart1 !== null) {

  var datos = $.getJSON("views/js/scripts_estadisticas/usuarios_niveles.php", function () {
    console.log("success");
  })
    .done(function (datos) {

      var options = {
        series: datos.totales,
        chart: {
        height: 380,
        type: 'radialBar',
      },
      ...
      var chart = new ApexCharts(radialBarChart1, options);
      chart.render();
    });
}
