...
$(document).ready(function () {
  ...
  var tablaUsuarios = $("#tablaUsuarios");
    ...
    var tablaNotificaciones = $("#tablaNotificaciones");
  ...
  /*======== 16. SELECT WITH SEARCH ========*/
  $(function() {
    $('#id_publicacion_comentar').selectpicker();
  });