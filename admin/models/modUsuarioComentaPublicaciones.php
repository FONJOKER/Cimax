...
class modUsuarioComentaPublicaciones{
    ...
    public static function mdlInsertarConImagen($tabla,$datos)
    {
        ...
        if($_FILES["foto"]["size"]>0)
        {
            ...
            else
            {
                ...
                modUsuarioComentaPublicaciones::mdlInsertarRegistros($tabla,$datos);
    ...
    public static function mdlBorrarRegistrosConImagen($tabla,$campo_filtrar,$valores_eliminar){
        ...
        //---- ELIMINAR IMAGENES----------------------------------
        $registros=modUsuarioComentaPublicaciones::mdlMostrarRegistros($tabla,null,null);
