...
class modUsuariosSeEncargaServicios{
    ...
    public static function mdlInsertarConImagen($tabla,$datos)
    {
        ...
        if($_FILES["foto"]["size"]>0)
        {
            ...
            else
            {
                ...
                modUsuariosSeEncargaServicios::mdlInsertarRegistros($tabla,$datos);
    ...
    public static function mdlBorrarRegistrosConImagen($tabla,$campo_filtrar,$valores_eliminar){
        ...
        //---- ELIMINAR IMAGENES----------------------------------
        $registros=modUsuariosSeEncargaServicios::mdlMostrarRegistros($tabla,null,null);
