...
class modUsuarioRecibeNotificaciones{
    ...
    public static function mdlInsertarConImagen($tabla,$datos)
    {
        ...
        if($_FILES["foto"]["size"]>0)
        {
            ...
            else
            {
                ...
                modUsuarioRecibeNotificaciones::mdlInsertarRegistros($tabla,$datos);
    ...
    public static function mdlBorrarRegistrosConImagen($tabla,$campo_filtrar,$valores_eliminar){
        ...
        //---- ELIMINAR IMAGENES----------------------------------
        $registros=modUsuarioRecibeNotificaciones::mdlMostrarRegistros($tabla,null,null);
