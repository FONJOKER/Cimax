...
class modUsuariosInscribeServicios{
    ...
    public static function mdlInsertarConImagen($tabla,$datos)
    {
        ...
        if($_FILES["foto"]["size"]>0)
        {
            ...
            else
            {
                ...
                modUsuariosInscribeServicios::mdlInsertarRegistros($tabla,$datos);
    ...
    public static function mdlBorrarRegistrosConImagen($tabla,$campo_filtrar,$valores_eliminar){
        ...
        //---- ELIMINAR IMAGENES----------------------------------
        $registros=modUsuariosInscribeServicios::mdlMostrarRegistros($tabla,null,null);
